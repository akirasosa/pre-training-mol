...
from mol.dimenet.functional import calculate_interatomic_distances, calculate_neighbor_angles
from mol.dimenet.loader import get_loader, AtomsBatch
from mol.dimenet.modules.bessel_basis_layer import BesselBasisLayer
from mol.dimenet.modules.embedding_block import EmbeddingBlock
from mol.dimenet.modules.interaction_block import InteractionBlock
from mol.dimenet.modules.output_block import OutputBlock
from mol.dimenet.modules.spherical_basis_layer import SphericalBasisLayer
...
class DimeNet(nn.Module):
    ...
    def forward(self, inputs: AtomsBatch):
        ...
        P_gathered = scatter_add(P, batch_seg, dim=0)
        # P_gathered = torch.zeros((n_batch, P.size(1))) \
        #     .type_as(P) \
